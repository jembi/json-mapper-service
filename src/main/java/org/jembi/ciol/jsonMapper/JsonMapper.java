...
public final class JsonMapper {
    ...
    private static final Logger LOGGER = LogManager.getLogger(JsonMapper.class.getName());
    ...
    private void run() {
        ...
        payloadProducer = new MyKafkaProducer<>(AppConfig.KAFKA_CLIENT_ID, GlobalConstants.TOPIC_PAYLOAD_QUEUE);
        notificationProducer = new MyKafkaProducer<>(AppConfig.KAFKA_CLIENT_ID, GlobalConstants.TOPIC_NOTIFICATIONS);
